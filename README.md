...
## Contexte académique
Ce projet a été réalisé dans le cadre du cours d'optimisation non linéaire . Il illustre l'application des méthodes d'optimisation à un problème d'ingénierie concret.
